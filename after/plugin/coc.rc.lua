...
keyset("n", "<leader>mm", ":CocCommand prettier.forceFormatDocument<cr>", {silent = true})

-- keyset("x", "<leader>mm", "<Plug>(coc-format-document)", {silent = true})
-- keyset("n", "<leader>mm", "<Plug>(coc-format-document)", {silent = true})
...
keyset("x", "<leader>ma", "<Plug>(coc-codeaction-selected)", opts)
...
-- keyset("n", "<leader>ma", "<Plug>(coc-codeaction-refactor)", { silent = true })
